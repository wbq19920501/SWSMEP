 ...
 * SWSMEP
 */
public class Work4Fragment extends Fragment{
    View fragment;
    private WorkTabAdapter adapter;
    private PullToRefreshListView work4_list;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if (fragment == null){
            fragment = inflater.inflate(R.layout.work4,container,false);
        }else {
                        ...
                        if (code==1){
                            ...
                            if (page==1){
                                if (array.length()==0){
                                    ...
                                    work4_list.setVisibility(View.GONE);
                                }else {
                                    no_msg.setVisibility(View.GONE);
                                    work4_list.setVisibility(View.VISIBLE);
                                }
                            }
                            work4_list.onRefreshComplete();
    ...
    public void refreshfragment(){
        ...
        adapter = new WorkTabAdapter(getActivity(),work1Infos,4,TOKENID);
