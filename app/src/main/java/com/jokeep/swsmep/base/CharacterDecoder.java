...
import java.nio.ByteBuffer;
      ...
      /**
   7    * This class defines the decoding half of character encoders.
   8    * A character decoder is an algorithim for transforming 8 bit
   9    * binary data that has been encoded into text by a character
   ...
   86    */
      ...
      public abstract class CharacterDecoder {
          ...
          /** Return the maximum number of bytes that can be encoded per line_xian */
          ...
          * could have been encoded on the line_xian.
          */
         ...
         /**
          * This method post processes the line_xian, if there are error detection
          * or correction codes in a line_xian, they are generally processed by
