...
/*
   ...
   75    */
      public abstract class CharacterEncoder {
          ...
          /** Return the number of bytes that can be encoded per line_xian */
         ...
         /**
          * Encode the prefix that starts every output line_xian.
          */
         ...
         /**
          * Encode the suffix that ends every output line_xian. By default
          ...
          * input stream, but does not print the line_xian suffix for a final
          * line_xian that is shorter than bytesPerLine().
          */
        ...
        /**
          ...
          * line_xian at the end of a final line_xian that is shorter than bytesPerLine().
          */
